...
( function() {
    ...
    $( function() {
        ...
        $(document).on( 'invalid.wpcf7' , function () {
            $( '.contact-us__support-wrap' ).find('input').removeClass( 'empty' );
            $( '.contact-us__support-wrap' ).find( '.wpcf7-not-valid-tip' ).each( function() {
    ...
    var TextureText = function( obj ) {
        ...
        _img.src = '/wp-content/themes/shaker-theme/img/text_texture.gif';
        ...
        var _addEvents = function() {
            ...
            _drawText = function( elem, canvas, ctx ) {
                ...
                ctx.drawImage(_img, 0, 0, _img.width , _img.height, 0, 0, canvas.width*2, canvas.height*2);
            },
