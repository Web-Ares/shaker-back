...
(function () {
    ...
    $(function () {
        ...
        //$.each($('#loginform-custom'), function () {
        //
        //    new LoginForm($(this));
        //
        //});
    ...
    var LoginForm = function (obj) {
        ...
        var _addEvents = function () {
            ...
            _setError = function () {
               ...
               $(_obj).find('.input_log').addClass('empty');
               $(_obj).find('.input_pass').addClass('empty');

            },
            _setVal = function () {

                _login = $(_obj).find('.input_log').val();
                _pass = $(_obj).find('.input_pass').val();
